...
public class RedisLockBak {
     ...
     * @return RLock
     */
    public static RLock lock(String serviceIndication) throws InterruptedException {
     ...
     * @return RLock
     */
    public static RLock lockByWaitTime(String appNo,String bizNo ,Integer waitTime) throws InterruptedException {
     ...
     * @return RLock
     */
    public static RLock lockByTimeout(String appNo,String bizNo ,Integer releaseTime) throws InterruptedException {
    ...
    public static RLock lock(String serviceIndication,Integer waitTime,Integer releaseTime) throws InterruptedException {
        RLock rLock = null;
        String waitTimeStr = PropertiesHandle.Factory.propertiesValue("redis.lock.default.waittime");
        String releaseTimeStr = PropertiesHandle.Factory.propertiesValue("redis.lock.default.timeout");
        if(waitTime == null || waitTime <= 0) {
        ...
        synchronized (serviceIndication) {
